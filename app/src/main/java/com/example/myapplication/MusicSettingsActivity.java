...
import com.example.myapplication.music.ui.adapter.FolderAdapter;
import com.example.myapplication.music.worker.MusicLoaderWorker;
import com.example.myapplication.ui.TitleListActivity;
...
public class MusicSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        folderAdapter = new FolderAdapter(this, folderItemList,
                ...
                (folder) -> {
                    Intent intent = new Intent(MusicSettingsActivity.this, TitleListActivity.class);
